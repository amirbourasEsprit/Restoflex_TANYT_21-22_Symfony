...
class StockController extends AbstractController
{
     ...
     */
    public function Add(Request $request, FlashyNotifier $flashy, GetUser $getUser)
    {
        $stock = new Stock();
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            $idfournisseur=$getUser->Get_User()->getIdFournisseur();
            $currentfourn= $this->getDoctrine()->getManager()->getRepository(Fournisseur::class)->find($idfournisseur);
            $stock->setIdFournisseur($currentfourn);
            $em = $this->getDoctrine()->getManager();
            $em->persist($stock);
            $em->flush();
