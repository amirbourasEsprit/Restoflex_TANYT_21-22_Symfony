...
return [
    ...
    [ // $staticRoutes
        ...
        '/addFact' => [[['_route' => 'addFact', '_controller' => 'App\\Controller\\FactureController::ajouterFacture'], null, null, null, false, false, null]],
        ...
        '/calcul/{$idCmd}' => [[['_route' => 'calcul', '_controller' => 'App\\Controller\\FactureController::calulT'], null, null, null, false, false, null]],
    ...
    [ // $dynamicRoutes
        ...
        189 => [[['_route' => 'updateFact', '_controller' => 'App\\Controller\\FactureController::modifierFacture'], ['numFacture'], null, null, false, true, null]],
        220 => [[['_route' => 'deleteFact', '_controller' => 'App\\Controller\\FactureController::supprimerFacture'], ['numFacture'], null, null, false, true, null]],
        246 => [[['_route' => 'detailsFact', '_controller' => 'App\\Controller\\FactureController::showDetailsFact'], ['numFacture'], null, null, false, true, null]],
        272 => [[['_route' => 'PDFFact', '_controller' => 'App\\Controller\\FactureController::showPDFFact'], ['numFacture'], null, null, false, true, null]],
        300 => [[['_route' => 'genPDFFact', '_controller' => 'App\\Controller\\FactureController::genererPDFFact'], ['numFacture'], null, null, false, true, null]],
        344 => [[['_route' => 'app_reset_password', 'token' => null, '_controller' => 'App\\Controller\\ResetPasswordController::reset'], ['token'], null, null, false, true, null]],
        371 => [[['_route' => 'modifRest', '_controller' => 'App\\Controller\\RestaurantController::modifierRestaurant'], ['idRest'], null, null, false, true, null]],
        397 => [
            [['_route' => 'suppRest', '_controller' => 'App\\Controller\\RestaurantController::supprimerRestaurant'], ['idRest'], null, null, false, true, null],
