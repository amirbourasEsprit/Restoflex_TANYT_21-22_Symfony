...
/* facture/modifier_fact.html.twig */
class __TwigTemplate_ead269137f67b15efff00ba5b49a255eb21f527d6ee29c16e70f9fb2f6fc9c3c extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e->enter($__internal_085b0142806202599c7fe3b329164a92397d8978207a37e79d70b8c52599e33e_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "facture/modifier_fact.html.twig"));

        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02 = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02->enter($__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "facture/modifier_fact.html.twig"));

        $this->parent = $this->loadTemplate("base.html.twig", "facture/modifier_fact.html.twig", 1);
...
\t\t\t\t\t\t\t\t";
        // line 49
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 49, $this->source); })()), "total", [], "any", false, false, false, 49), 'widget', ["attr" => ["disabled" => "disabled", "class" => "form-control form-control-user", "placeholder" => $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Total")]]);
        // line 50
        echo "
\t\t\t\t\t\t\t\t<div style=\"color:red;\">
\t\t\t\t\t\t\t\t\t";
...
\t\t\t\t\t\t\t\t";
        // line 63
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 63, $this->source); })()), "idRest", [], "any", false, false, false, 63), 'widget', ["attr" => ["disabled" => "disabled", "class" => "form-control form-control-user", "placeholder" => $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Email")]]);
        // line 64
        echo "
\t\t\t\t\t\t\t\t<div style=\"color:red;\">
\t\t\t\t\t\t\t\t\t";
...
\t\t\t\t\t\t\t\t\t";
    ...
    {
        return "facture/modifier_fact.html.twig";
    }
...
\t\t\t\t\t\t\t\t{{ form_widget(form.dateFacture,{ 'attr': {'disabled':'disabled', 'class': \"form-control form-control-user\",
...
\t\t\t\t\t\t<div class=\"form-group row\">
\t\t\t\t\t\t\t<div class=\"col-sm-6 mb-3 mb-sm-0\">
\t\t\t\t\t\t\t\t{{ form_widget(form.total,{ 'attr':{'disabled':'disabled', 'class': \"form-control form-control-user\",
                                            'placeholder': 'Total'|trans} }) }}
\t\t\t\t\t\t\t\t<div style=\"color:red;\">
\t\t\t\t\t\t\t\t\t{{ form_errors(form.total) }}</div>
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t<div class=\"col-sm-6\">
\t\t\t\t\t\t\t\t{{ form_widget(form.idFournisseur,{ 'attr': {'disabled':'disabled', 'class': \"form-control form-control-user\",
...
\t\t\t\t\t\t<div class=\"form-group row\">
\t\t\t\t\t\t\t<div class=\"col-sm-6 mb-3 mb-sm-0\">
\t\t\t\t\t\t\t\t{{ form_widget(form.idRest,{ 'attr': {'disabled':'disabled', 'class': \"form-control form-control-user\",
...
{% endblock %}
", "facture/modifier_fact.html.twig", "D:\\Nesrine Apps\\xxx\\htdocs\\Pidev_symfony_TANYT\\templates\\facture\\modifier_fact.html.twig");
    }
}
