...
class __TwigTemplate_546c5420864f595b84ae26a5b5a29d287fc9cdb1ca9157648accccde8c3fbbb3 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t";
        // line 83
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 83, $this->source); })()), "posteEmploye", [], "any", false, false, false, 83), 'widget', ["attr" => ["class" => "form-control form-control-user", "placeholder" => $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Poste employee")]]);
        // line 84
        echo "
\t\t\t\t\t\t\t\t<div style=\"color:red;\">
\t\t\t\t\t\t\t\t\t";
        // line 86
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 86, $this->source); })()), "posteEmploye", [], "any", false, false, false, 86), 'errors');
        echo "</div>
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t<div class=\"col-sm-6\">
\t\t\t\t\t\t\t\t";
...
\t\t\t\t\t\t\t\t{{ form_widget(form.posteEmploye,{ 'attr': {'class': \"form-control form-control-user\",
                                            'placeholder': 'Poste employee'|trans} }) }}
\t\t\t\t\t\t\t\t<div style=\"color:red;\">
...
{% endblock %}
", "register_employes/ajout_user.html.twig", "D:\\Nesrine Apps\\xxx\\htdocs\\Pidev_symfony_TANYT\\templates\\register_employes\\ajout_user.html.twig");
    }
}
