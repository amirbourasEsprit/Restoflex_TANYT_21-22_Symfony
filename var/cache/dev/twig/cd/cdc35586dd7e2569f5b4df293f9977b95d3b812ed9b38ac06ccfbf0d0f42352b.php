...
\t\t\t\t\t\t";
            // line 68
            if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 68, $this->source); })()), "user", [], "any", false, false, false, 68), "idRole", [], "any", false, false, false, 68), "nomRole", [], "any", false, false, false, 68), "admin"))) {
                // line 69
                echo "
\t\t\t\t\t\t\t<li class=\"nav-item\">
\t\t\t\t\t\t\t\t<a class=\"nav-link\" href=\"#\">
...
\t\t\t\t\t\t";
            // line 96
            if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 96, $this->source); })()), "user", [], "any", false, false, false, 96), "idRole", [], "any", false, false, false, 96), "nomRole", [], "any", false, false, false, 96), "Gérant"))) {
                // line 97
                echo "
\t\t\t\t\t\t\t<li class=\"nav-item\">
\t\t\t\t\t\t\t\t<a class=\"nav-link\" href=\"";
...
\t\t\t\t\t\t\t\t<a class=\"nav-link\" href=\"";
                // line 105
                echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("listFournisseurs");
                echo "\">
\t\t\t\t\t\t\t\t\t<i class=\"fas fa-fw fa-dolly\"></i>
\t\t\t\t\t\t\t\t\t<span>Fournisseurs</span>
\t\t\t\t\t\t\t\t</a>
...
\t\t\t\t\t\t";
            // line 140
            if (((0 === twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 140, $this->source); })()), "user", [], "any", false, false, false, 140), "idRole", [], "any", false, false, false, 140), "nomRole", [], "any", false, false, false, 140), "Employée")) && (0 === twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 140, $this->source); })()), "user", [], "any", false, false, false, 140), "statusCompte", [], "any", false, false, false, 140), "verifier")))) {
                // line 141
                echo "
\t\t\t\t\t\t\t<li class=\"nav-item\">
\t\t\t\t\t\t\t\t<a class=\"nav-link\" href=\"#\">
...
\t\t\t\t\t\t";
            // line 169
            if (((0 === twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 169, $this->source); })()), "user", [], "any", false, false, false, 169), "idRole", [], "any", false, false, false, 169), "nomRole", [], "any", false, false, false, 169), "Utilisateur_fournisseur")) && (0 === twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 169, $this->source); })()), "user", [], "any", false, false, false, 169), "statusCompte", [], "any", false, false, false, 169), "verifier")))) {
                // line 170
                echo "
\t\t\t\t\t\t\t<li class=\"nav-item\">
\t\t\t\t\t\t\t\t<a class=\"nav-link\" href=\"#\">
...
\t\t\t\t\t\t\t\t\t  ";
        ...
        if ($this->extensions['Symfony\Bridge\Twig\Extension\SecurityExtension']->isGranted("IS_AUTHENTICATED_FULLY")) {
            // line 267
            echo "                ";
            if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 267, $this->source); })()), "user", [], "any", false, false, false, 267), "statusCompte", [], "any", false, false, false, 267), "non_verifier"))) {
                // line 268
                echo "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<h5>Votre compte n'est pas verifié</h5>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
            }
            // line 270
            echo "\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
...
\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"mr-2 d-none d-lg-inline text-gray-600 small\">";
            // line 390
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 390, $this->source); })()), "user", [], "any", false, false, false, 390), "nom", [], "any", false, false, false, 390), "html", null, true);
            echo "
\t\t\t\t\t\t\t\t\t\t\t\t\t";
            // line 391
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 391, $this->source); })()), "user", [], "any", false, false, false, 391), "prenom", [], "any", false, false, false, 391), "html", null, true);
            echo "</span>
...
<script src=\"";
    ...
    {
        return array (  1211 => 824,  1207 => 823,  1201 => 820,  1195 => 817,  1189 => 814,  1183 => 811,  1179 => 810,  1176 => 809,  1166 => 808,  1149 => 796,  1139 => 795,  1097 => 753,  791 => 449,  781 => 448,  762 => 434,  742 => 416,  715 => 392,  711 => 391,  707 => 390,  703 => 389,  699 => 387,  697 => 386,  666 => 358,  652 => 347,  638 => 336,  571 => 271,  568 => 270,  564 => 268,  561 => 267,  559 => 266,  521 => 230,  511 => 229,  494 => 785,  492 => 448,  485 => 443,  483 => 229,  476 => 224,  466 => 223,  452 => 214,  440 => 198,  437 => 197,  408 => 170,  406 => 169,  403 => 168,  401 => 167,  397 => 165,  394 => 163,  391 => 162,  368 => 141,  366 => 140,  363 => 139,  360 => 138,  357 => 136,  354 => 135,  321 => 105,  312 => 99,  308 => 97,  306 => 96,  303 => 95,  301 => 94,  297 => 92,  295 => 91,  292 => 90,  282 => 83,  266 => 69,  264 => 68,  261 => 67,  258 => 66,  227 => 36,  217 => 35,  199 => 29,  181 => 27,  169 => 24,  160 => 19,  150 => 18,  130 => 13,  118 => 824,  116 => 808,  110 => 804,  108 => 795,  104 => 793,  102 => 223,  96 => 219,  94 => 35,  87 => 30,  85 => 29,  82 => 28,  80 => 27,  77 => 26,  75 => 18,  70 => 15,  68 => 13,  54 => 1,);
    }
...
\t\t\t\t\t<hr class=\"sidebar-divider\">
\t\t\t\t\t{# side bar pour l'admin de restoflex#}
\t\t\t\t\t{% if is_granted('IS_AUTHENTICATED_FULLY') %}

\t\t\t\t\t\t{% if app.user.idRole.nomRole==\"admin\"%}
...
\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t<li class=\"nav-item\">
\t\t\t\t\t\t\t\t<a class=\"nav-link\" href=\"{{ path ('role')}}\">
\t\t\t\t\t\t\t\t\t<i class=\"fas fa-cog\"></i>
\t\t\t\t\t\t\t\t\t<span>Rôles</span>
\t\t\t\t\t\t\t\t</a>
\t\t\t\t\t\t\t</li>
...
\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t\t<li class=\"nav-item\">
\t\t\t\t\t\t\t\t<a class=\"nav-link\" href=\"{{ path('listFournisseurs') }}\">
\t\t\t\t\t\t\t\t\t<i class=\"fas fa-fw fa-dolly\"></i>
\t\t\t\t\t\t\t\t\t<span>Fournisseurs</span>
\t\t\t\t\t\t\t\t</a>
\t\t\t\t\t\t\t</li>
...
\t\t\t\t\t\t{% if app.user.idRole.nomRole==\"Employée\" and app.user.statusCompte==\"verifier\"%}
...
\t\t\t\t\t\t{% if app.user.idRole.nomRole==\"Utilisateur_fournisseur\" and app.user.statusCompte==\"verifier\"%}
...
\t\t\t\t\t\t\t\t\t  {% if is_granted('IS_AUTHENTICATED_FULLY') %}
                {% if app.user.statusCompte=='non_verifier' %}
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<h5>Votre compte n'est pas verifié</h5>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t{% endif %}
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t{% endif %}
