...
/* base.html.twig */
class __TwigTemplate_23744bf2f6c3c7268b619e29d83a5cd9cf2270b956bc1403103b1419375969dd extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t";
            // line 70
            if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 70, $this->source); })()), "user", [], "any", false, false, false, 70), "idRole", [], "any", false, false, false, 70), "nomRole", [], "any", false, false, false, 70), "Gérant"))) {
                // line 71
                echo "
...
\t\t\t\t\t\t\t\t\t\t<a class=\"collapse-item\" href=\"";
                // line 102
                echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("AfficheTypeR");
                echo "\">Type Réclamations</a>
\t\t\t\t\t\t\t\t\t\t<a class=\"collapse-item\" href=\"";
                // line 103
                echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("AfficheR");
                echo "\">Mes Réclamations</a>
\t\t\t\t\t\t\t\t\t\t<a class=\"collapse-item\" href=\"";
                // line 104
...
\t\t\t\t\t\t";
            // line 117
            if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 117, $this->source); })()), "user", [], "any", false, false, false, 117), "idRole", [], "any", false, false, false, 117), "nomRole", [], "any", false, false, false, 117), "Employée"))) {
                // line 118
                echo "
\t\t\t\t\t\t\t<li class=\"nav-item\">
\t\t\t\t\t\t\t\t<a class=\"nav-link\" href=\"#\">
...
\t\t\t\t\t\t";
            // line 151
            if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 151, $this->source); })()), "user", [], "any", false, false, false, 151), "idRole", [], "any", false, false, false, 151), "nomRole", [], "any", false, false, false, 151), "Utilisateur_fournisseur"))) {
                // line 152
                echo "
\t\t\t\t\t\t\t<li class=\"nav-item\">
\t\t\t\t\t\t\t\t<a class=\"nav-link\" href=\"#\">
...
\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"mr-2 d-none d-lg-inline text-gray-600 small\">";
            // line 377
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 377, $this->source); })()), "user", [], "any", false, false, false, 377), "nom", [], "any", false, false, false, 377), "html", null, true);
            echo "
\t\t\t\t\t\t\t\t\t\t\t\t\t";
            // line 378
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 378, $this->source); })()), "user", [], "any", false, false, false, 378), "prenom", [], "any", false, false, false, 378), "html", null, true);
            echo "</span>
...
<script src=\"";
    ...
    {
        return array (  1181 => 804,  1177 => 803,  1171 => 800,  1165 => 797,  1159 => 794,  1153 => 791,  1149 => 790,  1146 => 789,  1136 => 788,  1119 => 776,  1109 => 775,  1069 => 737,  764 => 434,  754 => 433,  735 => 421,  715 => 403,  688 => 379,  684 => 378,  680 => 377,  676 => 376,  672 => 374,  670 => 373,  640 => 346,  626 => 335,  612 => 324,  502 => 216,  492 => 215,  477 => 767,  475 => 433,  470 => 430,  468 => 215,  461 => 210,  451 => 209,  439 => 202,  427 => 186,  424 => 185,  416 => 180,  386 => 152,  384 => 151,  381 => 150,  379 => 149,  375 => 147,  372 => 145,  369 => 144,  361 => 139,  338 => 118,  336 => 117,  333 => 116,  330 => 115,  327 => 113,  324 => 112,  313 => 104,  309 => 103,  305 => 102,  272 => 72,  269 => 71,  267 => 70,  264 => 69,  262 => 68,  258 => 66,  227 => 36,  217 => 35,  199 => 29,  181 => 27,  169 => 24,  160 => 19,  150 => 18,  130 => 13,  118 => 804,  116 => 788,  110 => 784,  108 => 775,  104 => 773,  102 => 209,  96 => 205,  94 => 35,  87 => 30,  85 => 29,  82 => 28,  80 => 27,  77 => 26,  75 => 18,  70 => 15,  68 => 13,  54 => 1,);
    }
...
\t\t\t\t\t\t\t\t<li class=\"nav-item\"> <a class=\"nav-link\" href=\"{{ path('listEmployes') }}\">
\t\t\t\t\t\t\t\t\t<i class=\"fas fa-fw fa-users\"></i>
\t\t\t\t\t\t\t\t\t<span>Employes</span>
\t\t\t\t\t\t\t\t</a>
\t\t\t\t\t\t\t</li>
...
\t\t\t\t\t\t\t\t<div id=\"collapseTwo\" class=\"collapse\" aria-labelledby=\"headingTwo\" data-parent=\"#accordionSidebar\">
\t\t\t\t\t\t\t\t\t<div class=\"bg-white py-2 collapse-inner rounded\">
\t\t\t\t\t\t\t\t\t\t<a class=\"collapse-item\" href=\"{{ path('AfficheTypeR')}}\">Type Réclamations</a>
\t\t\t\t\t\t\t\t\t\t<a class=\"collapse-item\" href=\"{{ path('AfficheR')}}\">Mes Réclamations</a>
\t\t\t\t\t\t\t\t\t\t<a class=\"collapse-item\" href=\"{{ path('stat')}}\">Statistiques
\t\t\t\t\t\t\t\t\t\t</a>
...
\t\t\t\t\t\t\t\t\t\t<a class=\"collapse-item\" href=\"{{ path('AfficheRC')}}\">Mes Réclamations</a>
\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t{% endif %}
...
\t\t\t\t\t\t\t\t\t\t<a class=\"collapse-item\" href=\"{{ path('AfficheRF')}}\">Mes Réclamations</a>
\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t</li>
\t\t\t\t\t\t{% endif %}
