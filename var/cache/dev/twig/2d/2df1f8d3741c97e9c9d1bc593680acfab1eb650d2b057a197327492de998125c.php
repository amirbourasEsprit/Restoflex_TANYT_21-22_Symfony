...
class __TwigTemplate_c6a68c000655eb29f64e916c65ce87da6a2dd6a3c534270420abebead0bc93af extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t<a href=\"";
        // line 41
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("AjoutreclamationGCL");
        echo "\" class=\"btn btn-success btn float-right col-sm col-md-3\">
\t\t\t\t\t\t\t<span class=\"icon text-white-50\">
\t\t\t\t\t\t\t\t<i style=\"float: left;\" class=\"material-icons mr-1\"></i>
\t\t\t\t\t\t\t</span>
\t\t\t\t\t\t\t<span class=\"text\">Ajouter Rec Employée</span>
\t\t\t\t\t\t</a>

\t\t\t\t\t\t<a href=\"";
        // line 48
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("AjoutreclamationGFO");
        echo "\" class=\"btn btn-success btn float-right col-sm col-md-3\">
\t\t\t\t\t\t\t<span class=\"icon text-white-50\">
\t\t\t\t\t\t\t\t<i style=\"float: left;\" class=\"material-icons mr-1\"></i>
\t\t\t\t\t\t\t</span>
\t\t\t\t\t\t\t<span class=\"text\">Ajouter Rec Fournisseur</span>
\t\t\t\t\t\t</a>
...
\t\t\t\t\t\t\t\t\t";
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["reclamation"]) || array_key_exists("reclamation", $context) ? $context["reclamation"] : (function () { throw new RuntimeError('Variable "reclamation" does not exist.', 85, $this->source); })()));
...
\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"";
            // line 88
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("show_rec", ["numReclamation" => twig_get_attribute($this->env, $this->source, $context["c"], "numReclamation", [], "any", false, false, false, 88)]), "html", null, true);
            echo "\">
\t\t\t\t\t\t\t\t\t\t\t\t\t";
            // line 89
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["c"], "numReclamation", [], "any", false, false, false, 89), "html", null, true);
            echo "</a>
\t\t\t\t\t\t\t\t\t\t\t</td>
\t\t\t\t\t\t\t\t\t\t\t<td>
\t\t\t\t\t\t\t\t\t\t\t\t";
            // line 92
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["c"], "destinataire", [], "any", false, false, false, 92), "html", null, true);
            echo "
\t\t\t\t\t\t\t\t\t\t\t</td>
\t\t\t\t\t\t\t\t\t\t\t<td>
\t\t\t\t\t\t\t\t\t\t\t\t";
            // line 95
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["c"], "statutReclamation", [], "any", false, false, false, 95), "html", null, true);
            echo "
\t\t\t\t\t\t\t\t\t\t\t</td>
\t\t\t\t\t\t\t\t\t\t\t<td>
\t\t\t\t\t\t\t\t\t\t\t\t";
            // line 98
            echo twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, $context["c"], "dateReclamation", [], "any", false, false, false, 98), "d/m/Y"), "html", null, true);
            echo "
\t\t\t\t\t\t\t\t\t\t\t</td>
...
\t\t\t\t\t\t\t\t\t\t\t\t";
            // line 103
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["c"], "idTypeReclamation", [], "any", false, false, false, 103), "nomTypeReclamation", [], "any", false, false, false, 103), "html", null, true);
            echo "
\t\t\t\t\t\t\t\t\t\t\t</td>
...
\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"";
            // line 107
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("r", ["numReclamation" => twig_get_attribute($this->env, $this->source, $context["c"], "numReclamation", [], "any", false, false, false, 107)]), "html", null, true);
...
\t\t\t\t\t\t\t<a href=\"";
        // line 115
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("ReclamationRecu", ["id" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 115, $this->source); })()), "user", [], "any", false, false, false, 115), "nom", [], "any", false, false, false, 115)]), "html", null, true);
        echo "\" class=\"btn btn-success btn float-right col-sm col-md-3\">
...
\t";
    ...
    {
        return array (  292 => 126,  282 => 125,  262 => 115,  258 => 113,  246 => 107,  239 => 103,  231 => 98,  225 => 95,  219 => 92,  213 => 89,  209 => 88,  205 => 86,  201 => 85,  161 => 48,  151 => 41,  139 => 31,  129 => 30,  96 => 7,  91 => 6,  81 => 5,  61 => 3,  38 => 1,);
    }
...
\t\t\t\t\t\t<a href=\"{{ path ('AjoutreclamationGCL') }}\" class=\"btn btn-success btn float-right col-sm col-md-3\">
\t\t\t\t\t\t\t<span class=\"icon text-white-50\">
\t\t\t\t\t\t\t\t<i style=\"float: left;\" class=\"material-icons mr-1\"></i>
\t\t\t\t\t\t\t</span>
\t\t\t\t\t\t\t<span class=\"text\">Ajouter Rec Employée</span>
...
\t\t\t\t\t\t<a href=\"{{ path ('AjoutreclamationGFO') }}\" class=\"btn btn-success btn float-right col-sm col-md-3\">
\t\t\t\t\t\t\t<span class=\"icon text-white-50\">
\t\t\t\t\t\t\t\t<i style=\"float: left;\" class=\"material-icons mr-1\"></i>
\t\t\t\t\t\t\t</span>
\t\t\t\t\t\t\t<span class=\"text\">Ajouter Rec Fournisseur</span>
...
\t\t\t\t\t\t\t\t</tbody>
\t\t\t\t\t\t\t</table>
\t\t\t\t\t\t\t<a href=\"{{ path('ReclamationRecu',{'id':app.user.nom}) }}\" class=\"btn btn-success btn float-right col-sm col-md-3\">
