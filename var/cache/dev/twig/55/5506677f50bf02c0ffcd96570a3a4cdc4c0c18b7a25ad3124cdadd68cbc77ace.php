...
\t\t\t\t\t\t\t<h1 class=\"h4 text-gray-900 mb-4\">Liste des Roles</h1>
\t\t\t\t\t\t</div>
\t\t\t\t\t\t<a href=\"\" class=\"btn btn-success btn float-right col-sm col-md-3\" data-toggle=\"modal\" data-target=\"#uploadModal\">
\t\t\t\t\t\t\t<span class=\"icon text-white-50\">
\t\t\t\t\t\t\t\t<i style=\"float: left;\" class=\"material-icons mr-2\">&#xE147;</i>
\t\t\t\t\t\t\t</span>
\t\t\t\t\t\t\t<span class=\"text\">Ajouter rôle</span>
\t\t\t\t\t\t</a>
...
\t\t\t\t\t\t\t\t\t";
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["roles"]) || array_key_exists("roles", $context) ? $context["roles"] : (function () { throw new RuntimeError('Variable "roles" does not exist.', 69, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["role"]) {
            // line 70
            echo "\t\t\t\t\t\t\t\t\t\t<tr>
\t\t\t\t\t\t\t\t\t\t\t<td>";
            // line 71
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["role"], "nomRole", [], "any", false, false, false, 71), "html", null, true);
            echo "</td>

\t\t\t\t\t\t\t\t\t\t\t<td>
\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"\" class=\"delete\" data-toggle=\"modal\" data-target=\"#deleteModal-";
            // line 74
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["role"], "idRole", [], "any", false, false, false, 74), "html", null, true);
            echo "\">
\t\t\t\t\t\t\t\t\t\t\t\t\t<i class=\"material-icons\">&#xE872;</i>
\t\t\t\t\t\t\t\t\t\t\t\t</a>
\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"modal fade\" id=\"deleteModal-";
            // line 77
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["role"], "idRole", [], "any", false, false, false, 77), "html", null, true);
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<form action=\"";
            // line 88
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("supprimer_role", ["idRole" => twig_get_attribute($this->env, $this->source, $context["role"], "idRole", [], "any", false, false, false, 88)]), "html", null, true);
            echo "\" method=\"POST\">
...
\t\t\t\t\t\t\t\t\t\t\t\t";
        // line 105
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 105, $this->source); })()), 'form_start', ["attr" => ["novalidate" => "novalidate", "class" => "user form-inline justify-content-center"]]);
        echo "
\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"form-group form-inline justify-content-center\">
\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-sm-6\">
\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
        // line 108
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 108, $this->source); })()), "nomRole", [], "any", false, false, false, 108), 'widget', ["attr" => ["class" => "form-control form-control-user", "placeholder" => $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Nom Rôle")]]);
        // line 109
        echo "
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
        // line 112
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 112, $this->source); })()), "nomRole", [], "any", false, false, false, 112), 'errors');
        echo "</div>
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
        // line 116
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 116, $this->source); })()), "captcha", [], "any", false, false, false, 116), 'widget', ["attr" => ["class" => "form-control form-control-user", "placeholder" => $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Tapez le Code")]]);
        // line 117
        echo "
\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div style=\"color:red;\">
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t";
        // line 120
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 120, $this->source); })()), "captcha", [], "any", false, false, false, 120), 'errors');
        echo "</div>
...
\$(this).toggle(\$(this).text().toLowerCase().indexOf(value) > -1)
    ...
    {
        return array (  319 => 149,  309 => 148,  283 => 133,  267 => 120,  262 => 117,  260 => 116,  253 => 112,  248 => 109,  246 => 108,  240 => 105,  236 => 104,  228 => 98,  212 => 88,  198 => 77,  192 => 74,  186 => 71,  183 => 70,  179 => 69,  139 => 31,  129 => 30,  96 => 7,  91 => 6,  81 => 5,  61 => 3,  38 => 1,);
    }
...
\t\t\t\t\t\t\t\t\t\t\t<td>
\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"\" class=\"delete\" data-toggle=\"modal\" data-target=\"#deleteModal-{{ role.idRole }}\">
\t\t\t\t\t\t\t\t\t\t\t\t\t<i class=\"material-icons\">&#xE872;</i>
\t\t\t\t\t\t\t\t\t\t\t\t</a>
\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"modal fade\" id=\"deleteModal-{{ role.idRole }}\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"deleteModalLabel\" aria-hidden=\"true\">
\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"modal-dialog\" role=\"document\">
\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"modal-content\">
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"modal-header\">
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<h5 class=\"modal-title\" id=\"deleteModalLabel\">Voulez vous supprimer ?</h5>
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"modal-footer\">
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<button type=\"button\" class=\"btn btn-secondary\" data-dismiss=\"modal\">Annuler</button>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<form action=\"{{ path ('supprimer_role', {'idRole':role.idRole }) }}\" method=\"POST\">
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input class=\"btn btn-danger\" type=\"submit\" value=\"Supprimer\">
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</form>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>
...
\t\t\t\t\t\t\t\t\t<div class=\"modal-content\">
\t\t\t\t\t\t\t\t\t\t<div class=\"p-2\">
\t\t\t\t\t\t\t\t\t\t\t<form action=\"{{path ('ajout_role')}}\" method=\"POST\" enctype=\"multipart/form-data\">
...
{% endblock %}{% block JsAfterTemplate %}
<script>
\t\$(document).ready(function () {
\$(\"#myInput\").on(\"keyup\", function () {
var value = \$(this).val().toLowerCase();
...
", "role/index.html.twig", "C:\\xampp\\htdocs\\Pidev_symfony_TANYT\\templates\\role\\index.html.twig");
    }
}
