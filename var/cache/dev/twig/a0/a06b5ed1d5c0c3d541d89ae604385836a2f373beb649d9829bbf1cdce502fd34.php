...
class __TwigTemplate_e489a6359378a1a458e07924b20b7996440200c40a949693f56a94c766c629f7 extends Template
{
    private $source;
    private $macros = [];
...
";
  ...
  <a href=\"http://localhost/Pidev_symfony_TANYT/public/index.php/ajstock\" class=\"btn btn-success btn float-right col-sm col-md-3\">                  <span class=\"icon text-white-50\">
        ...
        echo "                                    ";
        // line 83
        echo "                                  <th scope=\"col\">nom stock </th>
        ...
        echo "                                </tr>
                            ...
                            <h1>
                                Total Stock : ";
        // line 92
        echo twig_escape_filter($this->env, (isset($context["totalStock"]) || array_key_exists("totalStock", $context) ? $context["totalStock"] : (function () { throw new RuntimeError('Variable "totalStock" does not exist.', 92, $this->source); })()), "html", null, true);
        echo "
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["s"]) {
            ...
            // line 100
            echo "                                     <td> <a href=\"";
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("show", ["idStock" => twig_get_attribute($this->env, $this->source, $context["s"], "idStock", [], "any", false, false, false, 100)]), "html", null, true);
            echo "\" class=\"information\"> ";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["s"], "nomStock", [], "any", false, false, false, 100), "html", null, true);
            echo "</a>
                                         </td>
                                      <td>";
            // line 102
        ...
        // line 118
        echo "                                    <a  href=\"";
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("stock_stat");
        echo "\"> statistique 📈</a>
                                    <a  href=\"";
        // line 119
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("export");
        echo "\" class=\"alert-success\">Exporter Excel</a>
...
";
    ...
    {
        return array (  308 => 132,  298 => 131,  285 => 127,  276 => 119,  271 => 118,  263 => 115,  256 => 108,  251 => 106,  246 => 104,  242 => 103,  238 => 102,  230 => 100,  226 => 97,  222 => 96,  215 => 92,  210 => 89,  203 => 83,  201 => 82,  181 => 61,  170 => 58,  161 => 52,  158 => 51,  154 => 50,  140 => 38,  138 => 33,  128 => 32,  95 => 6,  90 => 5,  80 => 4,  61 => 3,  38 => 1,);
    }
                        ...
                        <table class=\"table table-hover \" id=\"myTable\">
                            ...
                            <tbody id=\"myTable\">
                              {% for s in list %}
                                ...
                                <tr>
                                    {#<td> {{s.idStock}}</td> #}
                                     <td> <a href=\"{{path('show',{'idStock':s.idStock})}}\" class=\"information\"> {{s.nomStock}}</a>
                                         </td>
                              ...
                              {#<td>
                                ...
                                {% endfor %}
                                    <a  href=\"{{ path('stock_stat') }}\"> statistique 📈</a>
