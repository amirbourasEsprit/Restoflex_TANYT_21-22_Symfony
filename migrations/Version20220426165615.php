 ...
 */
final class Version20220426165615 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE produit_restaurant (id_pdtrest INT AUTO_INCREMENT NOT NULL, id_rest INT DEFAULT NULL, id_categorie INT DEFAULT NULL, nom_pdt VARCHAR(255) NOT NULL, categ VARCHAR(255) NOT NULL, quantite_pdt DOUBLE PRECISION NOT NULL, INDEX IDX_42AD2B32C9486A13 (id_categorie), INDEX id_res_produit_fk (id_rest), PRIMARY KEY(id_pdtrest)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE utilisateur (id_utilisateur INT AUTO_INCREMENT NOT NULL, id_role INT DEFAULT NULL, id_rest INT DEFAULT NULL, id_fournisseur INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, cin VARCHAR(8) NOT NULL, mdp VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, num_tel VARCHAR(8) NOT NULL, date_naissance DATE NOT NULL, adresse VARCHAR(255) NOT NULL, salaire INT DEFAULT NULL, solde_conge INT DEFAULT 30, poste_employe VARCHAR(255) DEFAULT \'NULL\', Status_compte VARCHAR(255) DEFAULT \'\'\'non_verifier\'\'\' NOT NULL, INDEX id_role_util_fk (id_role), INDEX id_rest_util_fk (id_rest), INDEX id_four_util_fk (id_fournisseur), PRIMARY KEY(id_utilisateur)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE produit_restaurant ADD CONSTRAINT FK_42AD2B32C9486A13 FOREIGN KEY (id_categorie) REFERENCES categorie (id_categorie)');
        ...
        $this->addSql('ALTER TABLE reclamation ADD CONSTRAINT FK_CE60640466F3E644 FOREIGN KEY (id_type_reclamation) REFERENCES type_reclamation (id_type_reclamation)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit_restaurant DROP FOREIGN KEY FK_42AD2B32C9486A13');
